  ...
  return (
    <>
      ...
      <div className='flex items-center gap-2 mt-4'>
        <p onClick={() => nav('/')} className='bg-white text-black px-4 py-1 rounded-2xl cursor-pointer'>All</p>
        <p onClick={() => nav('/music')} className='bg-black px-4 py-1 rounded-2xl cursor-pointer'>Music</p>
        <p onClick={() => nav('/podcasts')} className='bg-black px-4 py-1 rounded-2xl cursor-pointer'>Podcasts</p>
      </div>
    </>
  )
}
